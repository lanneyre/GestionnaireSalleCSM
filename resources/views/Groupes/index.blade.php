...
@section('main')
    <table class="table table-striped" id="sortTablegroupe">
        <thead>
            <tr>
                <th scope="col">#</th>
                <th scope="col">Nom</th>
            ...
            @foreach ($groupes as $groupe)
                <tr class="{{ $groupe->status() }}">
                    ...
                    <td>
                        ...
                        @include('Groupes.modalView')
                    </td>
                    <td>
                        <a href="#" class="btn btn-outline-warning" tabindex="-1" role="button" aria-disabled="true"
                            data-toggle="modal" data-target="#ModalEdit{{ $groupe->id }}" data-toggle="modal"
                            data-target="#ModalEdit{{ $groupe->id }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
